...
pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/nolen'                                                 // <------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/nathaniel-stack/225-lab3-1.git'                   // <------change this
        KUBECONFIG = credentials('nolen-225')                                             // <------change this
    }
